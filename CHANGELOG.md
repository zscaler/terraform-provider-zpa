...
* New Resources: Introduced new Policy Access resources that are managed via a new `v2` API endpoint:
  - `zpa_policy_access_rule_v2` manages access policy rule via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
  - `zpa_policy_forwarding_rule_v2` manages access policy forwarding rule via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
  - `zpa_policy_isolation_rule_v2` manages access policy isolation rule via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
  - `zpa_policy_inspection_rule_v2` manages access policy inspection rule via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
  - `zpa_policy_timeout_rule_v2` manages access policy timeout rule via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
  - `zpa_policy_redirection_rule` manages redirection access policy via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/425)
  - `zpa_policy_credential_rule` manages access policy credential rule via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
  - `zpa_policy_capabilities_rule` manages access policy capabilities rule via `v2` API endpoint [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
...
* New Properties: The provider now includes support to `ZPATWO` cloud [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
...
* Deprecated attribute: The attributes `rule_order` within all access policy rule resource types. Please use the newly dedicated resource `zpa_policy_access_rule_reorder` [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428). 

### ENHACEMENTS
* Attribute `policy_set_id` is now optional across all access policy rule resources `v1` and `v2`. The provider will automatically set the `policy_set_id` according to the policy access resource being configured. This improvement removes the need to explicitly use the data source `zpa_policy_type` [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
* Added new `match_style` attribute to the `zpa_application_segment` resource [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428). Issue [#424](https://github.com/zscaler/terraform-provider-zpa/issues/424). To learn more about this attribute visit [Zscaler Help Portal](https://help.zscaler.com/zpa/using-app-segment-multimatch)
* Update `zpa_ba_certificate` documentation [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
* Several ACC tests maintenance [PR #428](https://github.com/zscaler/terraform-provider-zpa/pull/428)
