...
- [PR #618](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/618) - Added new attribute `approval_reviewers` to ZPA `zpa_pra_portal_controller` package.
...
- [PR #617](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/617) - Fixed `zpa_application_segment_pra` and `zpa_application_segment_inspection` resources not storing `pra_app_id`/`inspect_app_id` in state, which prevented proper updates and deletes of app configurations.
...
- [PR #612](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/612) - Added `zpa_application_segment_weightedlb_config` resource and data source to manage weighted load balancer configuration for application segments, including automatic lookup by application and server group name.

- [PR #612](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/612) - Added new attributes to `zpa_service_edge_group` attributes `exclusive_for_business_continuity`, and `city`
...
### Bug Fixes
[PR #611](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/611) - Upgraded to [Zscaler SDK GO v3.8.3](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.8.3)
...
### Bug Fixes
[PR #610](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/610) - Upgraded to [Zscaler SDK GO v3.8.2](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.8.2)
...
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added resource ``zpa_policy_portal_access_rule`` for Policy Portals access rule management
- [PR #588](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/588) - Added resource and datasource``zpa_zia_cloud_config`` to configure ZIA Sandbox settings. This is required when configuring the following policy types: `zpa_policy_capabilities_rule` or `zpa_policy_portal_access_rule`
- [PR #588](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/588) - Added resource and datasource``zpa_user_portal_aup`` for Acceptable Use Policy configuration
- [PR #588](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/588) - Added resource and datasource``zpa_application_segment_multimatch_bulk`` to get application segments by domain that are incompatible with application segment Multimatch and Bulk updates application segment Multimatch in multiple applications segments

### NEW - DATA SOURCES

The following new data sources have been introduced:

- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource ``zpa_workload_tag_group``. This data source can be used when configuring `zpa_policy_access_rule` or `zpa_policy_access_rule_v2`, `object_type` is `WORKLOAD_TAG_GROUP`
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_risk_score_values`. This data source can be used when configuring policy types that support the `object_type` `RISK_SCORE`
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_managed_browser_profile`. This data source can be used when configuring `zpa_policy_access_rule_v2` or `zpa_policy_isolation_rule_v2` where the `object_type` is `CHROME_POSTURE_PROFILE`
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_browser_protection`. This data source can be used when configuring `zpa_policy_browser_protection_rule`.
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_branch_connector_group`. This data source can be used when configuring `zpa_policy_access_rule` or `zpa_policy_access_rule_v2`, `zpa_policy_forwarding_rule`, `zpa_policy_forwarding_rule_v2`, where the `object_type` is `BRANCH_CONNECTOR_GROUP`
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_extranet_resource_partner`. This data source is required when configuring resources such as: `zpa_server_group`, `zpa_application_segment`, `zpa_application_segmnent_pra`, `zpa_policy_access_rule_v2` in [Extranet mode](https://help.zscaler.com/zia/about-extranet)
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_location_controller`. This data source is required when configuring resources such as: `zpa_policy_access_rule_v2`, `zpa_server_group`
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_location_group_controller`. This data source is required when configuring resources such as: `zpa_policy_access_rule_v2`, `zpa_server_group`
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Added datasource `zpa_location_controller_summary`. This data source can be used when configuring `zpa_policy_access_rule` or `zpa_policy_access_rule_v2` where the `object_type` is `LOCATION`

### Enhancements

- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - The resource `zpa_server_group` now supports [Extranet mode](https://help.zscaler.com/zia/about-extranet) configuration.
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - The resource `zpa_policy_access_rule_v2` now supports [Extranet mode](https://help.zscaler.com/zia/about-extranet) configuration.
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - The resource `zpa_application_segment` now supports [Extranet mode](https://help.zscaler.com/zia/about-extranet) configuration.

### Bug Fixes

- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Set attribute `enabled` to default value `true` for the resource `zpa_app_connector_group` due to API setting value to `false` when configuring via API.
- [PR #608](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/608) - Addressed edge case on `zpa_scim_groups` data source to handle group names containing special characther `@`.
...
[PR #602](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/602) - Implemented local caching for policy-controller resources for more efficiency on data source utilization.
[PR #602](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/602) - Upgraded to [Zscaler-SDK-GO v3.7.5](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.7.5) to leverage better rate limiting and retry logic mechanism.
...
[PR #600](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/600) - Updated index documentation for further clarity on ZPA Customer ID configuration
[PR #600](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/600) - Added additional examples within the examples folder for resources and datasources `zpa_c2c_ip_ranges`, `zpa_private_cloud_controller`, `zpa_private_cloud_group`, `zpa_user_portal_controller`, `zpa_user_portal_link`
...
[PR #596](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/596) - Introduced `GetByIdpAndAttributeID` in the data source `data_source_zpa_saml_attribute` to allow search IDP and Attribute ID. 
[PR #596](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/596) - Made `id` attribute optional in some datasources to allow for search by ID.
[PR #596](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/596) - Enhanced the Terraform schema in the following resources: `zpa_policy_inspection_rule` and `zpa_policy_isolation_rule`
...
[PR #593](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/593) - Removed computed attribute `enabled` from `common_apps_dto.apps_config`. PRA application segments are always enabled. and can only be disabled by removing it entirely.
...
### Bug Fixes
[PR #590](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/590) - Fixed `zpa_app_connector_group` resource attribute `lss_app_connector_group` due to API issues.
...
- [PR #588](https://github.com/SecurityGeekIO/terraform-provider-zia/pull/588) - Added and resource``zpa_c2c_ip_ranges`` - Added C2C IP Ranges
- [PR #588](https://github.com/SecurityGeekIO/terraform-provider-zia/pull/588) - Added and resource``zpa_private_cloud_group`` - Added Private Cloud Group
- [PR #588](https://github.com/SecurityGeekIO/terraform-provider-zia/pull/588) - Added and resource``zpa_user_portal_controller`` - Added User Portal Controller
- [PR #588](https://github.com/SecurityGeekIO/terraform-provider-zia/pull/588) - Added and resource``zpa_user_portal_link`` - Added User Portal Link

### NEW - DATA SOURCES

The following new data sources have been introduced:

- [PR #452](https://github.com/SecurityGeekIO/terraform-provider-zia/pull/452) - Added and datasource``zpa_private_cloud_controller`` - Retrieves private cloud controller.
...
### Bug Fixes
[PR #583](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/583) - Fixed attribute `servers` in the resource `zpa_server_groups` to prevent unexpected drifts.
...
### Enhancements
[PR #581](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/581) - Fixed `zpa_policy_access_rule_reorder` resource to ensure it ignores `Zscaler Deception` order when it is not present.
...
### Enhancements
[PR #578](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/578) - Added the attribute `share_to_microtenants` to resource `zpa_application_segment`. [Issue #577](https://github.com/SecurityGeekIO/terraform-provider-zpa/issues/577)
...
### Enhancements
[PR #576](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/576) - Updated the Policy Client Types: `zpn_client_type_zapp_partner`, `zpn_client_type_vdi`, `zpn_client_type_zia_inspection`
...
### Enhancements
[PR #348](https://github.com/SecurityGeekIO/zscaler-sdk-go/pull/348) - Added new Policy Client Types: `zpn_client_type_zapp_partner`, `zpn_client_type_vdi`, `zpn_client_type_zia_inspection` to data source: `zpa_access_policy_client_types`

### Bug Fixes
[PR #574](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/574) - Upgraded to [Zscaler GO SDK v3.4.4](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.4.3)
[PR #574](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/574) - Resolved a crash in the Terraform provider when `use_legacy_client = true`. The SDK's `NewOneAPIClient()` function was performing OAuth2 authentication unconditionally, which caused the provider to hang or fail during legacy client initialization. The logic has been updated to skip authentication when the legacy client is in use.
...
### Bug Fixes
[PR #572](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/572) - Upgraded to [Zscaler GO SDK v3.4.3](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.4.3)
[PR #572](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/572) - Fixed pagination encoding due to API changes.
...
### Enhancements
[PR #571](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/571) - Added new Access Policy Resource `zpa_policy_browser_protection_rule` to support ``USER_PORTAL`` `object_type`

### Documentation
[PR #571](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/571) - Updated all access policy documentations and examples.
...
### Enhancements
[PR #569](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/569) - Added support for PRA User Portal with Zscaler Managed Certificate to resource `zpa_pra_portal_controller`
[PR #570](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/570) - Added support for Zscaler Managed Certificate to resource `zpa_application_segment_browser_access`
...
### Bug Fixes
[PR #568](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/568) - Fixed panic on the resource `zpa_policy_credential_rule` due to missing nil pointer on the attribute `credential` and `credential_pool`
...
### Bug Fixes
[PR #564](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/564) - Fixed drift with attributes `reauth_idle_timeout` and `reauth_timeout` in the resource `zpa_policy_timeout_rule_v2`.
[PR #564](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/564) - Modified behavior of `service_edges` block in `zpa_service_edge_group` resource:
...
### Bug Fixes
[PR #561](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/561) - Fixed `zpa_server_group` panic during import process.
[PR #561](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/561) - Fixed `zpa_service_edge_group` drift with nested blocks. Notice that the `trusted_networks` and `service_edges` blocks can only repeated once.

[PR #561](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/561) - Enhanced nested flattening and expanding functions to provide more agnostic configuration when using dynamic blocks. The following resources are affected:
...
### Bug Fixes
[PR #557](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/557) - Fixed `zpa_server_group` panic during import process.
[PR #558](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/558) - Fixed `zpa_service_edge_group` drift with nested blocks. Notice that the `trusted_networks` and `service_edges` blocks can only repeated once.

[PR #558](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/558) - Enhanced nested flattening and expanding functions to provide more agnostic configuration when using dynamic blocks. The following resources are affected:
- `zpa_application_segment`
- `zpa_application_segment_pra`
- `zpa_application_segment_inspection`
- `zpa_application_segment_browser_access`
...
[PR #552](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/552) - The following new resource and data source have been introduced: `zpa_pra_credential_pool`. This resource creates a privileged remote access credential pool that can be referenced in an privileged credential access policy resource.

### Bug Fixes
[PR #552](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/552) - Enhanced nested flattening and expanding functions to provide more agnostic configuration when using dynamic blocks. The following resources are affected:
- `zpa_application_segment`
- `zpa_application_segment_pra`
- `zpa_application_segment_inspection`
- `zpa_application_segment_browser_access`
...
### Bug Fixes
[PR #552](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/552) - Fixed resource `zpa_application_segment_pra` to ensure proper PRA Application update and deletion process / cleanup.
...
### Bug Fixes
[PR #548](https://github.com/SecurityGeekIO/zscaler-sdk-go/pull/548) - Set pointer in the `credential` block attribute in the ZPA `policysetcontrollerv2` resource.
...
- [PR #546](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/546) - Fixed drift issue with the resources `zpa_policy_access_rule` and `zpa_policy_access_rule_v2` due to pre-populated attribute `custom_msg`.
- [PR #546](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/546) - Fixed `flattenServiceEdgeSimple` and `flattenAppTrustedNetworksSimple` functions in the resource `zpa_service_edge_group` to prevent drifts due to block count ordering.
- [PR #546](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/546) - Fixed documentation for `zpa_application_segment_pra` by removing the attribute `name` from within the `common_apps_dto.apps_config` block as it's not required.
...
- [PR #544](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/544) - Added new attribute `fqdn_dns_check` to all application segment resources.

### Bug Fixes

- [PR #544](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/544) - Fixed `zpa_service_edge_group` attributes `service_edges` and `trusted_networks` to prevent drifts due to attribute ordering.
...
- [PR #543](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/543) - Fixed `detachPRAConsoleFromPolicy` function within the resource `zpa_pra_console_controller` to ensure proper resource deletion flow.
...
- [PR #541](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/541) - Upgraded to [Zscaler SDK GO v3.1.11](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.1.11) to fix url encoding.
- [PR #541](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/541) - Fixed PRA Console, PRA Portal, PRA Credentials detachment functions to ensure proper removal from associated policies.
...
- [PR #537](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/537) - Upgraded to [Zscaler SDK GO v3.1.10](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.1.8) to fix url encoding.
...
- [PR #536](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/536) - Upgraded to [Zscaler SDK GO v3.1.9](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.1.8) to fix url encoding.
...
- [PR #534](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/534) - Upgraded to [Zscaler SDK GO v3.1.8](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.1.8) to fix url encoding.
...
- [PR #522](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/522) - Re-introduced attribute `cname` for the resource and data source `zpa_application_segment_browser_access` as a `Computed` only attribute.

### Internal Changes
- [PR #522](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/522) - Updated `version.go` to `v4.0.2`
- [PR #522](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/522) - Upgraded provider to [Zscaler SDK GO v3.1.4](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v3.1.4) to fix rate limiting override panic issues.
...
- [PR #516](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/516) - Removed `ConflictsWith` validation from `provider.go`. 
...
[PR #515](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/515): The ZPA Terraform Provider now offers support for [OneAPI](https://help.zscaler.com/oneapi/understanding-oneapi) Oauth2 authentication through [Zidentity](https://help.zscaler.com/zidentity/what-zidentity).
...
⚠️ **WARNING**: Please refer to the [Index Page](https://github.com/SecurityGeekIO/terraform-provider-zpa/blob/master/docs/index.md) page for details on authentication requirements prior to upgrading your provider configuration.

⚠️ **WARNING**: Attention Government customers. OneAPI and Zidentity is not currently supported for the following clouds: `GOV` and `GOVUS`. Refer to the [Legacy API Framework](https://github.com/SecurityGeekIO/terraform-provider-zpa/blob/master/docs/index) section for more information on how authenticate to these environments using the legacy method.

### NEW - RESOURCES, DATA SOURCES, PROPERTIES, ATTRIBUTES, ENV VARS

#### NEW ATTRIBUTES
- [PR #515](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/515) - Added new `object_type` `CHROME_ENTERPRISE` to the following ZPA access policy resources: `zpa_policy_access_rule`, and `zpa_policy_access_rule_v2`
...
### Bug Fixes
- [PR #513](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/513) - Upgraded Provider to SDK v2.74.2 to address Double encoding of special characters during GET operations.
- [PR #513](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/513) -Fixed attribute `app_server_groups` on `zpa_policy_access_rule` resource to prevent innadivertent drifts during plan and apply. Issue [#512](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/512)
- [PR #513](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/513) - Deprecated previous `3.331.0` version due to missconfigured semversioning hash calculation.
...
### Bug Fixes
- [PR #509](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/509) - Upgraded Provider to SDK v2.74.2 to address Double encoding of special characters during GET operations.
...
### Deprecations
- [PR #471](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/468) The following attributes are not deprecated:
  - ``zpa_application_segment_browser_access``: `cname`, `hidden`, `local_name`, `path`
  - ``zpa_application_segment_pra``: `cname`, `segment_group_name`

### Bug Fixes
- [PR #471](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/468) Fixed `zpa_application_segment_inspection` drift issues within `common_apps_dto` and `tcp_port_range`
- [PR #471](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/468) Fixed `zpa_inspection_custom_controls` drift issues `protocol_type` attribute
- [PR #471](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/468) Fixed `zpa_inspection_custom_controls`import issues.

### Enhancements
- [PR #471](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/468) Added new attributes to `zpa_cloud_browser_isolation_external_profile`:
...
### Deprecations
- [PR #468](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/468) The following attributes are not deprecated:
  - ``zpa_application_segment_browser_access``: `cname`, `hidden`, `local_name`, `path`
  - ``zpa_application_segment_pra``: `cname`, `segment_group_name`

### Bug Fixes
- [PR #468](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/468) Fixed `zpa_application_segment_inspection` drift issues within `common_apps_dto` and `tcp_port_range`
...
* New datasource: `zpa_pra_approval_controller` retrieve Privileged Remote Access Approval [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New resource: `zpa_pra_approval_controller` manages Privileged Remote Access Approval [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New datasource: `zpa_pra_portal_controller` retrieve Privileged Remote Access Portal [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New resource: `zpa_pra_portal_controller` manages Privileged Remote Access Portal [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New datasource: `zpa_pra_credential_controller` retrieve Privileged Remote Access Credential [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New resource: `zpa_pra_credential_controller` manages Privileged Remote Access Credential [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New datasource: `zpa_pra_console_controller` retrieve Privileged Remote Access Console [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New resource: `zpa_pra_console_controller` manages Privileged Remote Access Console [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
* New Resources: Introduced new Policy Access resources that are managed via a new `v2` API endpoint:
  ...
  - `zpa_policy_redirection_rule` manages redirection access policy via `v2` API endpoint [PR #432](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/425)
...
- [PR #350](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/350) - Update provider to [Zscaler SDK GO](https://github.com/SecurityGeekIO/zscaler-sdk-go/releases/tag/v1.8.0-beta) v1.8.0-beta. This version provides caching  mechanism, which aims to enhance the provider performance as well as decrease the number of API calls being made to the ZPA API.

### Fixes

- [PR #350](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/350) - Fixed drift within Access Policy Condition to ensure update is performed when adding and removing application segments.
...
- [PR #280](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/280) Added function to support detaching objects from Access policies prior to destroy operation.
...
- [PR #223](https://github.com/SecurityGeekIO/zscaler-sdk-go/pull/223) Fixed pagination issue with ZPA endpoints
...
- **zpa_application_segment_pra** - The resource supports enabling Priviledged Remote Access Application Segment ``SECURE_REMOTE_ACCESS``option for `RDP` and `SSH` via the ``app_types`` parameter. PR [#133](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/133)
...
- **zpa_inspection_all_predefined_controls** PR[#134](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/134)
...
- Fix: Fixed `enabled` parameter on **zpa_app_connector_group** resource by removing default action from resource schema. Issue [#128](https://github.com/SecurityGeekIO/terraform-provider-zpa/issues/128)
- Fix: Fixed Golangci linter and upgraded to golangci-lint-action@v3

### Documentation
1. Added release notes guide to documentation PR [#140](https://github.com/SecurityGeekIO/terraform-provider-zpa/pull/140)
