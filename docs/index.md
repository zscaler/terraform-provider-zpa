...
For the resources and data sources examples, please check the [examples](https://github.com/SecurityGeekIO/terraform-provider-zpa/tree/master/examples) directory.
