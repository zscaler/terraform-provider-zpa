# Create Policy Set Rule for Trusted Network

This example will show you how to create a policy set rule to validate if the user is within a trusted network.
