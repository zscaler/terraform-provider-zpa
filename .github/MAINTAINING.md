# Maintaining the Terraform ZPA Provider
...
Output from acceptance testing in ZPA:
...
```markdown
The fix for this has been merged and will release with a version X.Y.Z of the Terraform ZPA Provider, expected in the XXX timeframe.
```
