...
func TestAccResourcePolicyIsolationRuleV2_Basic(t *testing.T) {
...
func testAccCheckPolicyIsolationRuleV2Destroy(s *terraform.State) error {
	...
	accessPolicy, _, err := policysetcontrollerv2.GetByPolicyType(context.Background(), apiClient.Service, "ISOLATION_POLICY")
	if err != nil {
...
func testAccCheckPolicyIsolationRuleV2Exists(resource string) resource.TestCheckFunc {
	return func(state *terraform.State) error {
		...
		resp, _, err := policysetcontrollerv2.GetByPolicyType(context.Background(), apiClient.Service, "ISOLATION_POLICY")
		if err != nil {
			return fmt.Errorf("failed fetching resource ISOLATION_POLICY. Recevied error: %s", err)
		}
