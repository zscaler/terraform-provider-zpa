...
func TestAccResourcePRAPrivilegedApprovalControllerBasic(t *testing.T) {
	...
	domainName := "pra_user" + generatedName
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceTypeAndName, "email_ids.0", domainName+"@bd-hashicorp.com"),
...
func testAccCheckPRAPrivilegedApprovalConfigure(resourceTypeAndName, domainName, generatedName string) string {
