...
func TestAccDataSourcePRAConsoleController_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckPRAConsoleControllerConfigure(resourceTypeAndName, generatedName, generatedName, variable.PraConsoleDescription, variable.PraConsoleEnabled, applicationSegmentHCL, appSegmentTypeAndName, praPortalHCL, praPortalTypeAndName),
