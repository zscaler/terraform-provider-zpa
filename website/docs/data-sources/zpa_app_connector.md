...
The **zpa_app_connector** data source provides details about a specific app connector created in the Zscaler Private Access cloud. This data source can then be referenced in the following resources:
